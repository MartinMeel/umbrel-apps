  ...
  def do_POST(self):
      try:
          ...
          if path == '/api/apply':
              ...
              result = restore_backup(body.get('app_id'), body.get('backup_name'))
              self.send_json(result)
          else:
