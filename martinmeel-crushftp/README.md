Note: To mount the CrushFTP11 folder locally using Docker Compose, it will be mounted by default as the root user. To update the permissions of the local host volume, you can run the command 
